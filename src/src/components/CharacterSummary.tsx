...
export function CharacterSummary() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-stone-50 p-8 overflow-y-auto w-full font-serif">
      <div className="mb-8 border-b border-stone-200 pb-5">
        <h2 className="text-3xl font-serif text-stone-900 mb-2">{c.name || '未命名'}</h2>
        <div className="text-stone-600 text-sm flex flex-wrap gap-x-3 mt-1 font-sans">
          <span className="font-medium bg-stone-200 px-2 py-0.5 rounded text-stone-700">Level {c.level}</span>
          {race && (
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
            {(Object.entries(c.baseAbilities) as [Ability, number][]).map(([ab, val]) => {
              ...
              const total = val + bonus + subBonus;
        ...
        {/* Accumulated Traits */}
        <div>
          <h3 className="text-sm font-sans uppercase tracking-[0.15em] text-stone-400 mb-4 border-b border-stone-200 pb-2">特性与专长</h3>
