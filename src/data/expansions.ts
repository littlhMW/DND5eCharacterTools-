...
export const EXPANSIONS: ExpansionBook[] = [
  {
    ...
    classes: '野蛮人 (狂战士/图腾战士)、吟游诗人 (轶闻/勇气学院)、牧师 (知识/生命/光明/自然/风暴/诡术/战争领域)、德鲁伊 (大地/月亮结社)、战士 (战斗大师/勇士/魔能骑士)、武僧 (四象/散打/暗影宗)、圣骑士 (奉献/远古/复仇之誓)、游侠 (猎人/兽王)、游荡者 (刺客/诡术师/窃贼)、术士 (龙族血脉/狂野魔法)、契术师 (大恶魔/至高妖精/旧日支配者)、法师 (防护/咒法/预言/惑控/塑能/幻术/死灵/变化学派)',
  ...
  },
  {
    ...
    races: '阿斯莫 (堕落/守护者/天谴)、斑猫人、纯血蛇人、费尔伯格、歌利亚、天狗、蜥蜴人、梭螺鱼人、熊地精、地精、大地精、狗头人、兽人',
    classes: '（未提供新增子职业）',
    backgrounds: '（未提供新增背景）',
  ...
  },
  {
    ...
    races: '吉斯人 (吉斯洋基人/吉斯泽莱人)、矮人 (灰矮人)、精灵 (海精灵/雅灵/影灵)、提夫林 (九种大魔鬼血统)、地底侏儒',
    classes: '（未提供新增子职业）',
    backgrounds: '（未提供新增背景）',
  ...
  },
  {
    ...
    races: '半人马、牛头人(米诺陶)、维多肯、析米克混合体、象族、地精',
  ...
  },
  {
    ...
    races: '半人马、狮族、牛头人(米诺陶)、萨堤尔(羊人)、梭螺鱼人',
  ...
  },
  {
    ...
    name: '费资本的巨龙宝库',
    shortName: 'FOD',
    description: '巨龙巨匠费资本亲撰，颠覆传统的巨龙百科，探索巨龙族裔的深层血脉。',
  ...
  },
  {
    ...
    races: '阿兰寇拉鹰人、元素裔 (气/土/火/水)、地底侏儒 (斯奈布力)、歌利亚',
    classes: '（未提供新增子职业）',
    backgrounds: '（未提供新增背景）',
