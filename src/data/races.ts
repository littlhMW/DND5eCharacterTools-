  ...
  choices: [
    {
      ...
      chooseNumber: 1,
      options: [
        { id: 'alert', name: '警觉', description: '+5先攻，不能被突袭' },
        { id: 'lucky', name: '幸运', description: '每天3次，重骰攻击/豁免/检定' },
        { id: 'great-weapon-master', name: '巨武器大师', description: '重武器命中可选-5攻+10伤' },
        { id: 'sharpshooter', name: '神射手', description: '远程命中可选-5攻+10伤' },
        { id: 'warcaster', name: '战地施法者', description: '专注优势和反应施法' }
      ]
    }
  ]
}
